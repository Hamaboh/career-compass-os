...
-- A MEMBER execution must erase the approval snapshot's stable source key. This
-- narrowly scoped exception preserves preview immutability during approval while
-- permitting the terminal, irreversible anonymization step.
